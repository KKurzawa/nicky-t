...
const AudioPlayer = () => {
    return (
        <article className='audio-player-main flex flex-col w-[80%] lg:gap-5'>
            ...
            <p className='spotify-note mt-2 lg:mt-0'>*Spotify player is for preview purposes. Please support Nicky T and The Snakecharmers and live music by purchasing merchandise on the audio page.</p>
        </article>
